...
This is a Hexo theme based on [Next](https://github.com/iissnan/hexo-theme-next), I've done some changes of styles. Also, I wrote a new scheme called `Radian`. And all the documentation is the same as original. Enjoy it!
