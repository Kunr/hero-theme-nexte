...
这是一个基于 [Next](https://github.com/iissnan/hexo-theme-next) 的主题，我对他进行了一些样式上的修改。并且新增一个 Schema 叫做 `Radian`。本项目的文档均采用原案，因为没有什么很大的不同。请尽情享受。

> 精于心，简于形

[NexT 使用文档](http://theme-next.iissnan.com) | [English Documentation](README.en.md)
